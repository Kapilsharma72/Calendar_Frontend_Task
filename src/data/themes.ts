...
export const MONTH_THEMES: MonthThemes = [
  ...
  // 10 - November: muted burgundy/brown
  {
    name: 'November',
  ...
  // 11 - December: festive deep red/gold
  {
    name: 'December',
